...
- [x] Contrast fixes using `--color-primary-dark` (project-card heading, mobile nav
  links) and a darker error-text red that meets AA; de-duplicated the
  `.error-message` style into `main.css`.
